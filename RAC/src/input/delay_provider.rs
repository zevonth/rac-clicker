...
impl DelayProvider {
    ...
    pub fn get_next_delay(&mut self) -> Duration {
        ...
        let micro_adjust: i32 = rng.random_range(self.random_deviation_min..=self.random_deviation_max);
        let adjusted_delay = if micro_adjust < 0 {
        ...
        if adjusted_delay < Duration::from_micros(70000) {
            return Duration::from_micros(70000);
        }
        adjusted_delay
    }
}